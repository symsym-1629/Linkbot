    ...
    async execute(interaction) {
        ...
        if (interaction.options.getSubcommand() == "pouvoir") {
            ...
            if (rollp == 1) {
                ...
                interaction.editReply("**Bravo ! On dirait bien que tu as été initié à l\'art de la rotation, ou spin !**\n\n**Cependant, ta maîtrise de ce style de combat laisse à désirer... Tu commences à peine à apprendre les bases de cet art complexe !**\n\n```Tu n'es bien sur pas obligé d'inclure le spin dans ta fiche. Tu peux tout simplement choisir de ne garder que le stand, ou de garder le spin en plus, ou encore ne conserver que le spin... Comme tu veux !```\n\nhttps://tenor.com/view/gyro-zeppelin-gyro-sbr-steell-ball-run-jojo-gif-21200046")
